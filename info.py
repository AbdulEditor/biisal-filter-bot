...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://maheshsbabu8074:Abdul@786@cluster786.j0vks.mongodb.net/?retryWrites=true&w=majority&appName=Cluster786")
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002400548727'))
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002285292296'))
...
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002481979047'))
